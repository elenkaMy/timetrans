...
<?php echo $form->dropDownListRow($model, 'parent_page_id', array('' => '') + $model->getAllowedParentsForList(), array('class' => 'span5')); ?>

<?php echo $form->textFieldRow($model, 'page_name', array('class' => 'span5 russian-text', 'maxlength' => 255)); ?>
