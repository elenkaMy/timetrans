...
<?php $this->widget('bootstrap.widgets.TbTabs', array(
    ...
    'tabs' => array(
        ...
        array('label'=>Yii::t('admin', 'Gallery'), 'content' => $this->renderPartial('form/_gallery', array('model' => $model, 'form' => $form), true)),
    ),
)); ?>
    ...
    <div class="form-actions">
        ...
        <?php $this->widget('application.widgets.PreviewWidget', array(
            'url' => $model->isNewRecord ? $this->createUrl('previewOnCreate') : $this->createUrl('previewOnUpdate', array('product_id' => $model->id)),
            'formId' => $formId,
        ));
        ?>
    </div>
