 ...
 * @property Product|boolean $model the loaded model or false if not exists or not found.
 */
class AdminProductController extends AdminController
{
    const GET_PARAM_NAME = 'product_id';
    ...
    */
    ...
    /**
     * @param Product|boolean $model or false if empty model.
    ...
    public function setModel($model)
    {
        if ($model instanceof Product) {
            ...
            throw new CException('Incorrect model type. Product or false required.');
        }
    }
    ...
    {
        return $this->module->viewPath.DIRECTORY_SEPARATOR.'product';
    }
    ...
    protected function validateAndSave($view)
    {
        ...
        if ($this->request->isPostRequest) {
            $model->attributes = $this->request->getPost('Product', array());
    ...
    {
        if ($this->request->getPost('ajax', false) === 'product-form') {
    ...
    {
        $this->_model = new Product('adminInsert');
    ...
    public function actionIndex()
    {
        ...
        $model->attributes = (array)$this->request->getQuery('Product', array());
    ...
    public function validateAndPreview($view)
    {
        ...
        $model = $this->getModel();
        $model->attributes = $this->request->getPost('Product');
        $self = $this;
        ...
        if ($model->save()) {
            ...
            $this->forwardWithParams( '/product/product/index', array(
                'id'        =>  $model->id,
                'record'    =>  $model,
