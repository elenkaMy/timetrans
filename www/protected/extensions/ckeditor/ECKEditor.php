...
class ECKEditor extends CInputWidget {
    ...
    public function  __construct($owner=null) {
		...
		$_SESSION['KCFINDER']['uploadURL'] = Yii::app()->baseUrl."/upload/page/"; // URL for the uploads folder
		$_SESSION['KCFINDER']['uploadDir'] = $_SERVER['DOCUMENT_ROOT']."/upload/page/"; // path to the uploads folder
