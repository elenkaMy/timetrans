...
{
    /**
     * @var string default: realpath(__DIR__.'/../../assets')
     */
    public $defaultAssetsPath = null;
    ...
    public function init()
    {
        ...
        if (is_null($this->defaultAssetsPath)) {
            $this->defaultAssetsPath = realpath(__DIR__.'/../../assets');
        }
    }
    ...
    public function actionAssets($assetPath = null)
    {
        ...
        if ($assetPath === null) {
            $assetPath = $this->defaultAssetsPath;
